    ...
    <div className="timer-page">
            ...
            {isEditingTime ? (
              <div className="timer-edit-box">
                ...
                <div className="timer-edit-actions">
                  ...
                  <button className="timer-edit-save" onClick={handleEditSave}>
                    <Check size={14} /> Lưu
                  </button>
                </div>
              </div>
              ...
              <>
                ...
                {cur && !isRunning && (
                  <button className="timer-edit-btn" onClick={openEdit} title="Chỉnh thời gian">
                    <Pencil size={12} />
                    Chỉnh giờ
                  </button>
                )}
      ...
      <div className="timer-right">
        ...
        <div className="panel">
          ...
          {sessions.length === 0 ? (
            <p className="empty-msg">Chưa có session nào. Nhấn + để thêm.</p>
          ) : (
