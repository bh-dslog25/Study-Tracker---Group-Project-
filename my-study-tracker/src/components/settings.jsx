...
function ProfileSection() {
  ...
  const [email, setEmail]   = useState('alex@example.edu');
  const [bio, setBio]       = useState('Computer Science major focusing on AI. Usually found in the library on Tuesdays.');
  ...
  return (
    <div className="settings-section">
      ...
      <div className="section-footer">
        <button className="btn-outline" onClick={() => { setName('Alex Student'); setEmail('alex@example.edu'); setBio('Computer Science major focusing on AI. Usually found in the library on Tuesdays.'); }}>
          Cancel
        </button>
